                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-around align-items-start gap-4 p-3">
                            ...
                            <div class="flex-fill">
                                <span class="badge rounded-pill bg-secondary mb-2">Employee Grades Before Supervisor Review </span>
                            ...
                            <div class="flex-fill">
                                <span class="badge rounded-pill bg-primary mb-2">Supervisor Grade For Employee Before Confirmation</span>
                        ...
                        <div class="p-3 text-muted">
                            <div id="kpi-form">
                                ...
                                <div class="kpi">
                                    ...
                                    <div class="card border border-primary section-tab" @style(['border-radius: 10px;']) @style(['border-radius: 10px; display: none;']) data-section-page="{{ floor($sectionIndex / 3) }}">
                                            ...
                                            <div class="section-card" style="margin-top: 1rem;">
                                                ...
                                                <form action="{{ route('self.rating') }}" method="POST" class="ajax-eval-form section-form">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <div class="col-md-2">
                                                            <input class="form-control mb-3 score-input" type="number" name="sectionEmpScore" required placeholder="Enter Score" min="0" step="0.01" pattern="\d+(\.\d{1,2})?" max="{{ $section->sectionScore }}" title="The Score cannot be more than the section score {{ $section->sectionScore }}" @disabled(isset($section->sectionEmpScore) &&
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control mb-3 comment-input" type="text" name="employeeComment" required placeholder="Enter your comments" @disabled(isset($section->sectionEmpScore) &&
                                                        ...
                                                        <button type="submit" @style(['height: fit-content']) class="btn btn-success">Save</button>
                                                ...
                                                <div class="d-flex gap-3">
                                                    <div class="col-md-2">
                                                        <input class="form-control mb-3" type="number" readonly name="metricSupScore" placeholder="Enter Score" required value="{{ optional($section->sectionEmpScore)->sectionSupScore ?? '' }}">
                                                    </div>
                                                    <div class="col-md-9">
                                                        <textarea class="form-control mb-3" type="text" readonly name="supervisorComment" placeholder="Enter your comments" required rows="3">{{ $section->sectionEmpScore->supervisorComment ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                @elseif(
                                                ($section->sectionEmpScore->status === 'CONFIRMATION' || $section->sectionEmpScore->status === 'COMPLETED') &&
                                                ...
                                                <div class="d-flex gap-3">
                                                    <div class="col-md-2">
                                                        <input class="form-control mb-3" type="number" readonly name="metricSupScore" placeholder="Enter Score" required value="{{ optional($section->sectionEmpScore)->sectionProbScore ?? '' }}">
                                                    </div>
                                                    <div class="col-md-9">
                                                        <textarea class="form-control mb-3" type="text" readonly name="supervisorComment" placeholder="Enter your comments" required rows="3">{{ $section->sectionEmpScore->probComment ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                @endif
                                                @endif
                                                        ...
                                                        <div class="metric-card">
                                                            ...
                                                            <form action="{{ route('self.rating') }}" method="POST" class="ajax-eval-form metric-form">
                                                                ...
                                                                <div class="d-flex gap-3">
                                                                    ...
                                                                    <input type="hidden" name="sectionId" value="{{ $section->sectionId }}">
                                                                    <div class="col-md-2">
                                                                        <input class="form-control mb-3" type="number" name="metricEmpScore" required placeholder="Enter Score" min="0" step="0.01" pattern="\d+(\.\d{1,2})?" max="{{ $metric->metricScore }}" title="The Score cannot be more than the section score {{ $metric->metricScore }}" @disabled( (isset($metric->metricEmpScore) && in_array($metric->metricEmpScore->status, ['REVIEW', 'CONFIRMATION'])) ||
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <textarea class="form-control mb-3" type="text" name="employeeComment" required placeholder="Enter your comments" rows="3" @disabled( (isset($metric->metricEmpScore) && in_array($metric->metricEmpScore->status, ['REVIEW', 'CONFIRMATION'])) ||
                                                            ...
                                                            <div class="d-flex gap-3">
                                                                <div class="col-md-2">
                                                                    <input class="form-control mb-3" type="number" readonly name="metricSupScore" placeholder="Enter Score" required value="{{ optional($metric->metricEmpScore)->metricSupScore ?? '' }}">
                                                                </div>
                                                                <div class="col-md-9">
                                                                    <textarea class="form-control mb-3" type="text" readonly name="supervisorComment" placeholder="Enter your comments" required rows="3">{{ $metric->metricEmpScore->supervisorComment ?? '' }}</textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex gap-3">
                                                                <div class="col-md-2">
                                                                    <input class="form-control mb-3" type="number" readonly name="metricSupScore" placeholder="Enter Score" required value="{{ optional($metric->metricEmpScore)->metricProbScore ?? '' }}">
                                                                </div>
                                                                <div class="col-md-9">
                                                                    <textarea class="form-control mb-3" type="text" readonly name="supervisorComment" placeholder="Enter your comments" required rows="3">{{ $metric->metricEmpScore->probComment ?? '' }}</textarea>
                                                                </div>
                                                            </div>
                                                            @endif
                                                            @endif
                            ...
                            <div class="float-end">
                                <div class="d-flex gap-3 pagination-controls">
                                    ...
                                    <button id="submit-btn" type="button" data-bs-toggle="modal" class="btn btn-success" data-bs-target=".bs-delete-modal-lg" id="submitAppraisalButton" disabled>Submit Appraisal</button>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('submit.appraisal') }}" method="POST" id="appraisalForm">
                                                ...
                                                <div class="d-grid">
                                                    ...
                                                    <button type="submit" id="submitReviewButton" class="btn btn-success">Submit Appraisal For
                                                        Review</button>
                            ...
                            <div class="float-end">
                                <div class="d-flex gap-3">
                                    <button type="button" data-bs-toggle="modal" class="btn btn-primary" @style(['width: 8rem; height: fit-content']) data-bs-target=".bs-delete-modal-lg">Accept</button>

                                    <button type="button" data-bs-toggle="modal" class="btn btn-dark" @style(['width: 8rem; height: fit-content']) data-bs-target=".bs-push-review-modal-lg">Push for Review</button>

                                    <a href="{{ route('show.employee.probe', $kpi->kpi->kpiId) }}" class="btn btn-warning" @style(['width: 8rem; height: fit-content'])>Probe</a>
                                </div>
                            </div>
                            ...
                            <div class="modal fade bs-push-review-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-md modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('submit.appraisal') }}" method="POST" id="appraisalForm">
                                                ...
                                                <div class="d-grid">
                                                    ...
                                                    <button type="submit" id="submitReviewButton" class="btn btn-warning">Push Appraisal Back For
                                                        Review</button>
