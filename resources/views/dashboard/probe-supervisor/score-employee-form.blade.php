                                                        ...
                                                        <div class="section-card" style="margin-top: 2rem;">
                                                            ...
                                                            @if ($section->metrics->isEmpty())
                                                                ...
                                                                <div class="d-flex gap-3">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <textarea class="form-control mb-3 comment-input" type="text" name="supervisorComment"
                                                                            placeholder="Enter your comments" @disabled(isset($section->sectionEmpScore) && in_array($section->sectionEmpScore->status, ['CONFIRMATION', 'PROBLEM'])) rows="3">{{ $section->sectionEmpScore->supervisorComment ?? '' }}</textarea>
                                                                    </div>
                                                                ...
                                                                <form action="{{ route('prob.store') }}" method="POST"
                                                                    class="section-form ajax-sup-eval-form">
                                                                    @csrf
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <div class="d-flex gap-3">
                                                                            ...
                                                                            <div class="col-md-9">
                                                                                <textarea class="form-control mb-3 comment-input" type="text" name="probComment" placeholder="Enter your comments"
                                                                                    @disabled(isset($section->sectionEmpScore) && in_array($section->sectionEmpScore->status, ['COMPLETED'])) rows="3">{{ $section->sectionEmpScore->probComment ?? '' }}</textarea>
                                                                            </div>
                                                                                ...
                                                                                <div class="d-flex gap-3">
                                                                                    ...
                                                                                    <div class="col-md-9">
                                                                                        <textarea class="form-control mb-3 comment-input" type="text" name="employeeComment"
                                                                                            placeholder="Enter your comments" readonly @disabled(isset($metric->metricEmpScore) && in_array($metric->metricEmpScore->status, ['CONFIRMATION', 'PROBLEM'])) rows="3">{{ $metric->metricEmpScore->employeeComment ?? '' }}</textarea>
                                                                                    </div>
