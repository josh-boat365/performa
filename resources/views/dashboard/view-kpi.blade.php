                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="vertical-example" class="vertical-wizard">
                            <!-- Seller Details -->
                            <h3>This is a long text for a kpi representation, if it will fit well, just in case it is a
                                long text, just like this</h3>
                            <section>
                                <form>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-firstname-input"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-lastname-input" placeholder="Enter Your Last Name">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-phoneno-input" placeholder="Enter Your Phone No.">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-servicetax-input"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-companyuin-input" placeholder="Company UIN No.">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-Declaration-input"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="verticalnav-expiration-input"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="basic-example">
                            <!-- Seller Details -->
                                                        <h3>This is a long text for a kpi representation, if it will fit well, just in case it is a long text, just like this</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="basicpill-firstname-input" placeholder="Enter Your First Name">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
