        ...
        <div class="col-md-12">
            ...
            <div class="card card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <span class="badge rounded-pill bg-warning fonte-size-13">In-Progress</span>
                ...
                <div class="mt-3">
                    <div class="progress">
                        <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar"
                            style="width: 70%; font-weight: 900;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">70%</div>
                    </div>
                </div>
