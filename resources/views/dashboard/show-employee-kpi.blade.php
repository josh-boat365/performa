                ...
                <div class="card card-body mb-10">
                    <div class="d-flex justify-content-between">
                        @if (isset($employeeKpi['id']) && isset($employeeKpi['batch_id']))
                            <a
                                href="{{ route('show.employee.kpi', ['id' => $employeeKpi['id'], 'batchId' => $employeeKpi['batch_id']]) }}">
                    ...
                    <div class="modal fade bs-recommendation-modal-lg" tabindex="-1" role="dialog"
                        aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myLargeModalLabel">Supervisors Recommendation About Your
                                        Performance</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="p-3 mb-2 bg-light text-dark border rounded">
                                        @if (isset($gradeDetails['recommendation']) && !empty($gradeDetails['recommendation']))
                                            <p>{{ ($gradeDetails['recommendation'] ?? 'No Recommendation') === 'No Recommendation' ? '___' : $gradeDetails['recommendation'] }}
                                            </p>
                                        @else
