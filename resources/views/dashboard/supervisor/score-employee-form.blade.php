                        ...
                        <div class="p-3 text-muted">
                                            ...
                                            <div class="section-card" style="margin-top: 2rem;">
                                                ...
                                                <form action="{{ route('supervisor.rating') }}" method="POST" class="section-form">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <div class="col-md-2">
                                                            <input class="form-control mb-3 score-input" type="number" name="sectionSupScore" required placeholder="Enter Score" min="0" pattern="\d+(\.\d{1,2})?" max="{{ $section->sectionScore }}" @disabled(isset($section->sectionEmpScore) && in_array($section->sectionEmpScore->status, ['CONFIRMATION', 'PROBLEM']))
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control mb-3 comment-input" type="text" name="supervisorComment" required placeholder="Enter your comments" rows="3" @disabled(isset($section->sectionEmpScore) && in_array($section->sectionEmpScore->status, ['CONFIRMATION', 'PROBLEM']))>{{ $section->sectionEmpScore->supervisorComment ?? '' }}</textarea>
                                                        </div>
                                                ...
                                                <div class="card border border-success" @style(['border-radius: 10px;'])>
                                                    <div class="card-body" @style(['background-color: #1eff000d'])>
                                                        <div class="metric-card">
                                                            ...
                                                            <form action="{{ route('supervisor.rating') }}" method="POST" class="ajax-sup-eval-form">
                                                                @csrf
                                                                <div class="d-flex gap-3">
                                                                    <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <textarea class="form-control mb-3" type="text" required name="supervisorComment" @disabled(isset($metric->metricEmpScore) && in_array($metric->metricEmpScore->status, ['CONFIRMATION', 'PROBLEM']))
                                                                    ...
                                                                    <button type="submit" style="height: fit-content" @disabled(isset($metric->metricEmpScore) && in_array($metric->metricEmpScore->status, ['CONFIRMATION', 'PROBLEM']))
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('submit.appraisal') }}" method="POST">
                                                ...
                                                <div class="d-grid">
                                                    ...
                                                    <button type="submit" id="submitReviewButton" class="btn btn-success">Submit
                                                        Employee Appraisal
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    // Enhanced AJAX form handler with toast notifications and page refresh functionality
