<x-base-layout>
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#section-configuration" role="tab">
                    <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                    <span class="d-none d-sm-block">Section Configuration</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#column-configuration" role="tab">
                    <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                    <span class="d-none d-sm-block">Column Configuration</span>
                </a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="section-configuration" role="tabpanel">
        ...
        <!-- Tab panes -->
        <div class="tab-content">
            <div class="tab-pane" id="column-configuration" role="tabpanel">
                <form action="#">
                    <div class=" d-flex">
                        <div class="w-100">
                            <div class="w-100">
